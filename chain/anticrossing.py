...
ax.set_xlim(205, 125); ax.set_ylim(1.497, 1.536)
ax.set_xlabel("silicon taper width (nm), light travels right to left along the taper", fontsize=10.5)
...
ax.grid(alpha=.22); ax.legend(fontsize=9.5, loc="lower left")
