...
ax1.text(L_BEAT / 2, 1.04, f"{L_BEAT/2:.0f} µm", ha="center", color="#c0392b")
ax1.text(L_BEAT, 1.04, f"{L_BEAT:.0f} µm", ha="center", color="#c0392b")
